...
public class FilmeRecomendadosDAO {
    private List<Filme> filmes;

    public FilmeRecomendadosDAO() {
        filmes = new ArrayList<>();
    }

    public void carregarFilmesRecomendadosDoJson(String jsonResponse) throws JSONException {
        if (jsonResponse != null) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Log.i("", "carregarFilmesRecomendadosDoJson: " + filme);
                salvarFilme(filme);
            }
        }
    }
