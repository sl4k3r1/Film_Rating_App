...
public class FilmesMelhoresAvaliadosDAO {
    private List<Filme> filmes;

    public FilmesMelhoresAvaliadosDAO() {
        filmes = new ArrayList<>();
    }

    public void carregarFilmesMelhoresAvaliadosDoJson(String jsonResponse) throws JSONException {
