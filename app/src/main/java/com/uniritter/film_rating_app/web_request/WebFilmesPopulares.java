...
import com.uniritter.film_rating_app.dao.FilmesPopularesDAO;
...
public class WebFilmesPopulares {
    private static final String URL = "https://api.themoviedb.org/3/movie/popular?language=pt-BR&page=1&region=BR";
    ...
    public void carregarFilmesPopulares(CallBack callBack) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    try {
                        FilmesPopularesDAO filmesPupularesDAO = new FilmesPopularesDAO();
                        filmesPupularesDAO.carregarFilmesPuplaresDoJson(jsonResponse);
                        filmesPupularesDAO.getFilmes();
                        callBack.filmes(filmesPupularesDAO.getFilmes());
